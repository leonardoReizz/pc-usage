...
def get_usage_stats():
    ...
    # Calcula cores em uso: (porcentagem_uso * total_cores) / 100
    cores_in_use = round((cpu_percent * physical_cores) / 100, 2)
    ...
    return {
        'cpu': {
            ...
            'usage': cores_in_use  # Agora representa o número real de cores em uso
        },
        'memory': {
            'totalGB': mem_total,
            'usedGB': mem_used
